...
class MenuHelper
{
    ...
    public static function getIconSvg($iconName)
    {
        $icons = [
            ...
            'ai-building' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none"
            xmlns="http://www.w3.org/2000/svg">
            <path d="M4 20H20" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
            <path d="M6 20V4.5C6 3.67157 6.67157 3 7.5 3H11.5C12.3284 3 13 3.67157 13 4.5V20"
            stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M13 20V7.5C13 6.67157 13.6716 6 14.5 6H18.5C19.3284 6 20 6.67157 20 7.5V20"
            stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M8.5 7.5H10M8.5 11H10M8.5 14.5H10
            M15.5 10H17M15.5 13.5H17M15.5 17H17"
