...
<div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
        ...
        <div class="flex items-start justify-between">
            ...
            <div>
                ...
                <div class="flex items-center justify-center w-12 h-12 bg-gray-100 rounded-xl dark:bg-gray-800">
                    <svg class="fill-gray-800 dark:fill-white/90" width="24" height="24" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <!-- Percentage -->
            <!-- <span
                class="inline-flex items-center gap-1 rounded-full bg-green-100 px-2.5 py-1 text-sm font-semibold text-green-600 dark:bg-green-900/30 dark:text-green-400">
    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <x-chart-card title="Jumlah per Jabatan">
            <div id="chart-jabatan" class="h-64"></div>
        </x-chart-card>

        <x-chart-card title="Jumlah per Divisi">
            <div id="chart-divisi" class="h-64"></div>
        </x-chart-card>

        <x-chart-card title="Pendidikan Terakhir">
            <div id="chart-pendidikan" class="h-64"></div>
        </x-chart-card>

        <x-chart-card title="Masa Kerja">
            <div id="chart-tenure" class="h-64"></div>
        </x-chart-card>

        <x-chart-card title="Rentang Usia">
            <div id="chart-age" class="h-64"></div>
        </x-chart-card>

        <div class="lg:col-span-3">
            <x-chart-card title="Jumlah Karyawan per Perusahaan">
                <div id="chart-perusahaan" class="h-80"></div>
            </x-chart-card>
        </div>
