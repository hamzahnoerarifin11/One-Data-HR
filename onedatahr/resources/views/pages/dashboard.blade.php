...
<div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
    ...
    <div class="mb-8">
        ...
        <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
            ...
            @if(auth()->user()->isStaff())
                semangat bekerja dan jangan lupa isi penilaian Anda!
            @else
    ...
    {{-- ================================================================= --}}
    {{-- TAMPILAN KHUSUS STAFF (Simple Mode)                               --}}
    {{-- ================================================================= --}}
    @if(auth()->user()->isStaff())
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        
        <a href="{{ url('/kpi/dashboard') }}" class="group relative flex items-center gap-4 rounded-2xl border border-gray-200 bg-white p-6 shadow-sm transition hover:shadow-md hover:border-blue-300 dark:border-gray-800 dark:bg-white/[0.03]">
            <div class="flex h-14 w-14 items-center justify-center rounded-xl bg-blue-50 text-blue-600 dark:bg-blue-900/50 dark:text-blue-400">
                 <i class="fas fa-chart-line text-2xl"></i> {{-- Gunakan ikon FontAwesome atau SVG --}}
            </div>
            <div>
                <h3 class="text-lg font-bold text-gray-900 dark:text-white group-hover:text-blue-600">KPI Saya</h3>
                <p class="text-sm text-gray-500">Cek target & pencapaian.</p>
            </div>
        </a>

        <a href="{{ url('/kbi/dashboard') }}" class="group relative flex items-center gap-4 rounded-2xl border border-gray-200 bg-white p-6 shadow-sm transition hover:shadow-md hover:border-purple-300 dark:border-gray-800 dark:bg-white/[0.03]">
            <div class="flex h-14 w-14 items-center justify-center rounded-xl bg-purple-50 text-purple-600 dark:bg-purple-900/50 dark:text-purple-400">
                <i class="fas fa-tachometer-alt text-2xl"></i>
            </div>
            <div>
                <h3 class="text-lg font-bold text-gray-900 dark:text-white group-hover:text-purple-600">KBI Saya</h3>
                <p class="text-sm text-gray-500">Isi penilaian perilaku.</p>
            </div>
        </a>

        <div class="rounded-2xl border border-blue-100 bg-blue-50 p-6 dark:border-blue-900 dark:bg-blue-900/20">
            <h3 class="text-sm font-bold text-blue-800 dark:text-blue-300 mb-1">Pengumuman</h3>
            <p class="text-xs text-blue-600 dark:text-blue-400">
                Pastikan seluruh penilaian periode ini diselesaikan sebelum tanggal 25.
            </p>
        </div>
    ...
    {{-- ================================================================= --}}
    {{-- TAMPILAN KHUSUS ADMIN / HRD (Full Statistik)                      --}}
    {{-- ================================================================= --}}
    @if(!auth()->user()->isStaff())
...
@push('scripts')
{{-- JAVASCRIPT HANYA DIRENDER UNTUK ADMIN/HRD --}}
{{-- Agar tidak error di halaman Staff karena elemen chart tidak ditemukan --}}
@if(!auth()->user()->isStaff())
<script>
