...
@section('content')
    <div class="relative z-1 min-h-screen bg-black">
        <div class="relative min-h-screen flex items-center justify-center p-6">
                ...
                <div class="relative bg-white/95 dark:border dark:bg-gray-900/95 rounded-2xl shadow-xl p-6 sm:p-8">
                    <div>
                        <div class="mb-6 text-center">
                            ...
                            <h1 class="text-title-md mb-1 font-semibold text-gray-900 dark:text-white">Welcome back</h1>
                            <p class="text-sm text-gray-600 dark:text-gray-400">Sign in to One Data HR — manage HR data in one place.</p>
                        </div>
                        <!-- Social sign-ins hidden for compact modal -->
                        <div class="mb-6 hidden">
                            <p class="text-xs text-gray-500 dark:text-gray-400">Sign in with</p>
                        </div>
                        <div>
                            <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-5 hidden">
                                <button
                                    class="inline-flex items-center justify-center gap-3 rounded-lg bg-white/80 border border-gray-200 px-7 py-3 text-sm font-semibold text-gray-700 transition-colors hover:bg-white hover:shadow-lg dark:bg-white/5 dark:text-white/90 dark:hover:bg-white/10">
                            ...
                            <div class="relative py-3 sm:py-5 hidden">
                            ...
                            <form method="POST" action="{{ route('signin.post') }}" class="bg-transparent p-0">
                                ...
                                <div class="space-y-5">
                                    ...
                                    <div>
                                        ...
                                        <input type="email" id="email" name="email" placeholder="you@gmail.com" value="{{ old('email') }}" autocomplete="username" autofocus
                                            class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-12 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" />
                                    </div>
                                    <!-- Password -->
                                    <div>
                                        <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                                        ...
                                        <div x-data="{ showPassword: false }" class="relative">
                                            ...
                                            <span @click="showPassword = !showPassword" role="button" aria-label="Toggle password visibility"
                                    ...
                                    <div class="flex items-center justify-between">
                                        <div x-data="{ checkboxToggle: false }">
                                            <label for="checkboxLabelOne"
                                                ...
                                                <div class="relative">
                                                    <input type="checkbox" id="checkboxLabelOne" name="remember" value="1" class="sr-only" x-model="checkboxToggle" />
                                    ...
                                    <div>
                                        <button type="submit"
                                            class="bg-brand-500 shadow-theme-xs hover:bg-brand-600 flex w-full items-center justify-center rounded-lg px-4 py-3 text-sm font-semibold text-white transition">
                                            Sign In
                                        </button>
                                    </div>
                                </div>
            ...
            <!-- Right panel removed for centered modal layout -->
            <!-- Theme toggler removed from auth modal for minimal UI -->
        </div>
    </div>
@endsection
