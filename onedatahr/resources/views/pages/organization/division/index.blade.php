...
<div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
    ...
    <div class="mb-6 flex flex-wrap items-center justify-between gap-4">
        <div>
            ...
            <p class="mt-1 text-gray-600 dark:text-gray-400">
                Kelola data divisi perusahaan yang terdaftar
            </p>
        </div>

        <a href="{{ route('organization.division.create') }}"
    ...
    <div x-data="divisionTable()" class="rounded-xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/20 transition">
                            ...
                            <td class="px-5 py-4 text-center">
                                <div class="flex items-center justify-center gap-2">
                                    <a :href="'{{ url('organization/division') }}/' + row.id + '/edit'"
                                    ...
                                    <form :action="'{{ url('organization/division') }}/' + row.id" method="POST"
                                        @submit.prevent="if(confirm('Apakah Anda yakin ingin menghapus divisi ini?')) $el.submit()">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
                    ...
                    <template x-if="filtered.length === 0">
                        <tr>
                            <td colspan="5" class="px-5 py-10 text-center text-sm text-gray-500 dark:text-gray-400">
                                Belum ada data divisi ditemukan.
                            </td>
                        </tr>
                    </template>
                </tbody>
