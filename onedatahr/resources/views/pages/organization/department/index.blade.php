...
<div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
    ...
    <div class="mb-6 flex flex-wrap items-center justify-between gap-4">
        <div>
            ...
            <p class="mt-1 text-gray-600 dark:text-gray-400">
                Kelola data departemen perusahaan yang terdaftar
            </p>
        </div>

        <a href="{{ route('organization.department.create') }}"
    ...
    <div x-data="departmentTable()" class="rounded-xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/20 transition">
                            ...
                            <td class="px-5 py-4 text-center">
                                <div class="flex items-center justify-center gap-2">
                                    <a :href="'{{ url('organization/department') }}/' + row.id + '/edit'"
                                    ...
                                    <form :action="'{{ url('organization/department') }}/' + row.id" method="POST"
                                        @submit.prevent="if(confirm('Apakah Anda yakin ingin menghapus departemen ini?')) $el.submit()">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
