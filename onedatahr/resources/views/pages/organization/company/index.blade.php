...
<div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
    ...
    <div class="mb-6 flex flex-wrap items-center justify-between gap-4">
        ...
        <a href="{{ route('organization.company.create') }}"
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/20 transition">
                            ...
                            <td class="px-5 py-4 text-center">
                                <div class="flex items-center justify-center gap-2">
                                    ...
                                    <form :action="'{{ url('organization/company') }}/' + row.id" method="POST"
                                        @submit.prevent="if(confirm('Apakah Anda yakin ingin menghapus perusahaan ini?')) $el.submit()">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
                    ...
                    <template x-if="filtered.length === 0">
                        <tr>
                            <td colspan="4" class="px-5 py-10 text-center text-sm text-gray-500 dark:text-gray-400">
                                Belum ada data perusahaan ditemukan.
                            </td>
                        </tr>
                    </template>
                </tbody>
...
function companyTable() {
    return {
        ...
        sortCol: 'name',
        sortDir: 'asc',
        baseUrl: '{{ route("organization.company.index") }}',
