    ...
    <div class="mb-6 flex flex-wrap items-center justify-between gap-4">
        <div>
            ...
            <p class="mt-1 text-gray-600 dark:text-gray-400">
                Kelola data unit perusahaan yang terdaftar
            </p>
        </div>

        <a href="{{ route('organization.unit.create') }}"
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/20 transition">
                            ...
                            <td class="px-5 py-4 text-center">
                                <div class="flex items-center justify-center gap-2">
                                    <a :href="'{{ url('organization/unit') }}/' + row.id + '/edit'"
                                    ...
                                    <form :action="'{{ url('organization/unit') }}/' + row.id" method="POST"
                                        @submit.prevent="if(confirm('Apakah Anda yakin ingin menghapus unit ini?')) $el.submit()">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
            ...
            <div class="flex items-center gap-2">
                ...
                <template x-for="p in displayedPages" :key="p">
                    <button @click="goToPage(p)"
                            x-show="p !== '...'"
                            :class="page === p ? 'bg-blue-600 text-white' : 'hover:bg-blue-500/[0.08] hover:text-blue-500 dark:text-gray-400 dark:hover:text-blue-500 dark:text-white'"
