    ...
    <div x-data="interviewTable()" class="rounded-xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
        ...
        <div class="flex flex-wrap items-center justify-between gap-3 px-6 py-4">
            ...
            <div class="relative flex items-center gap-3">
                <select x-model="year" @change="resetPage" class="dark:bg-dark-900 h-11 w-40 appearance-none rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 pr-8 text-sm text-gray-800 outline-none focus:border-blue-600 focus:ring-1 focus:ring-blue-600 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90">
