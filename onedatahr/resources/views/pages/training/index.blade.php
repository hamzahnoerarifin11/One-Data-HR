    ...
    <div x-data="trainingTable()" class="rounded-xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
        ...
        <div class="flex items-center justify-between px-6 py-4 border-t border-gray-200 dark:border-gray-700">
            ...
            <div class="flex items-center gap-2">
                <button @click="prevPage" :disabled="page === 1" class="rounded-lg border border-gray-300 px-3 py-1.5 text-sm dark:border-gray-700 dark:text-white disabled:opacity-50 transition hover:bg-gray-100 dark:hover:bg-gray-700">Prev</button>
                <template x-for="p in displayedPages" :key="p">
                    <button @click="goToPage(p)"
                        :class="page === p ? 'bg-blue-600 text-white border-blue-600' : 'border-gray-300 dark:border-gray-700 hover:bg-blue-500/[0.08] hover:text-blue-500 dark:text-gray-400 dark:hover:text-blue-500 dark:text-white'"
                        class="px-3 py-1 text-sm rounded-lg border transition" x-text="p"></button>
                </template>
                <button @click="nextPage" :disabled="page === totalPages" class="rounded-lg border border-gray-300 px-3 py-1.5 text-sm dark:border-gray-700 dark:text-white disabled:opacity-50 transition hover:bg-gray-100 dark:hover:bg-gray-700">Next</button>
            </div>
        </div>
    </div>
</div>
