            ...
            <form id="formEditKPI" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" id="edit_target" name="target" class="w-full border border-slate-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-amber-500 focus:border-amber-500 outline-none {{ $isStaff ? 'bg-slate-100 text-slate-500 cursor-not-allowed' : '' }}" required {{ $isStaff ? 'readonly' : '' }}>
                    </div>
                </div>
                <div class="mt-8 flex justify-end gap-3 pt-4 border-t border-slate-100">
