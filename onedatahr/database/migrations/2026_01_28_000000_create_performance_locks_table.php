...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('performance_locks', function (Blueprint $table) {
            ...
            $table->bigInteger('locked_by')->unsigned()->nullable()->comment('User yang lock');
            $table->timestamp('locked_at')->nullable()->comment('Waktu lock');
            $table->bigInteger('unlocked_by')->unsigned()->nullable()->comment('User yang unlock (hanya superadmin)');
